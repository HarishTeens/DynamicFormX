...
interface CustomCreatableSelectProps<OptionType, IsMulti extends boolean, GroupType extends GroupBase<OptionType>> extends CreatableProps<OptionType, IsMulti, GroupType> {
  // Add any additional props you want to include
...
>({
  ...
  indicator,
  ...rest
}: CustomCreatableSelectProps<OptionType, IsMulti, GroupType>) => {
  const uniqueId = useGenerateUniqueId("creatable-select");
